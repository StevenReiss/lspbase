/********************************************************************************/
/*                                                                              */
/*              LspBasePreferences.java                                         */
/*                                                                              */
/*      Preferences data structure and I/O                                      */
/*                                                                              */
/********************************************************************************/
...
class LspBasePreferences implements LspBaseConstants
{
...
LspBasePreferences(File preffile)
{
   this();
   base_file = preffile;
...
LspBasePreferences(LspBasePreferences par)
{
   this();
   pref_props.putAll(par.pref_props);
}

private LspBasePreferences()
{
...
public void flush()
{
   if (base_file != null) {
	 ...
	 LspLog.logE("Problem saving preferences file " + base_file,e);
       }
    }
}
...
}       // end of class LspBasePreferences




/* end of LspBasePreferences.java */
